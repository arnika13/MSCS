...
class BorrowedBook(models.Model):
	...
	borrowed_book_id = models.OneToOneField(Book,related_name='borrowed_book_id')
...
class Reviews(models.Model):
	borrowed_book_transaction_id = models.ForeignKey(BorrowedBook,related_name='borrowed_book_transaction_id')
...
class BookRequests(models.Model):
	borrower_username = models.ForeignKey(BookLeaseUser,related_name='borrower_username')
	book_id = models.ForeignKey(Book,related_name='book_id')
	bookowner_username = models.ForeignKey(BookLeaseUser,related_name='bookowner_username')
